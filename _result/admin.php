...
<head>
	...
	<link rel="stylesheet" type="text/css" href="static/css/mos-style.css">
	<script type="text/javascript" src="static/js/jquery.1.7.2.min.js"></script>
	<script type="text/javascript" src="static/lib/tinymce/jscripts/tiny_mce/jquery.tinymce.js"></script>
</head>
<body>
<div id="header">
	<div class="inHeader">
	...
	<div id="rightContent">
		...
		<table class="data"><tbody>
			...
			<tr class="data">
				...
				<td class="data"></td>
				<td class="data"><a href="media.php?modul=agenda&amp;act=edit&amp;id=3"><img a="" <="" title="edit data" src="static/image/edit.png"> | 
					</a><a href="agenda_aksi.php?modul=agenda&amp;act=hapus&amp;id=3"><img title="hapus data" src="static/image/delete.png"></a></td>
				</tr>
			<tr class="data"><td class="data">2</td>
				...
				<td class="data"></td>
				<td class="data"><a href="media.php?modul=agenda&amp;act=edit&amp;id=2"><img a="" <="" title="edit data" src="static/image/edit.png"> | 
					</a><a href="agenda_aksi.php?modul=agenda&amp;act=hapus&amp;id=2"><img title="hapus data" src="static/image/delete.png"></a></td>
				</tr>
			<tr class="data"><td class="data">3</td>
				...
				<td class="data"></td>
				<td class="data"><a href="media.php?modul=agenda&amp;act=edit&amp;id=1"><img a="" <="" title="edit data" src="static/image/edit.png"> | 
					</a><a href="agenda_aksi.php?modul=agenda&amp;act=hapus&amp;id=1"><img title="hapus data" src="static/image/delete.png"></a></td>
				</tr>
		</tbody></table>

...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
	$config['base_url']		= 'http://localhost'.$PortAddress.'/mitradesain/trunk';
	$config['base_path']	= realpath(dirname(__FILE__) . '/../..');
} else if ($_SERVER['SERVER_NAME'] == 'develweb.ub.ac.id') {
	$config['base_url']		= 'http://develweb.ub.ac.id/selma2013';
	$config['base_path']	= realpath(dirname(__FILE__) . '/../..');
} else {
...
|
*/
$config['log_path'] = realpath(dirname(__FILE__) . '/../..') . '/application/_logs';
